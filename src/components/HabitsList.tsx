...
interface HabitsListProps {
    date: Date;
    onDayModify: (completed: number, maxHabits: number) => void
}
...
export function HabitsList({ date, onDayModify }: HabitsListProps) {
    const [habitsInfos, setHabitsInfo] = useState<HabitsInfo>();
    ...
    async function handleToggleHabit(habitId: string) {
        ...
        let completedHabits = habitsInfos!.completedHabits;
        ...
        onDayModify(completedHabits.length, habitsInfos!.possibleHabits.length);
    }
